...
**本轮官方最新版本升级请求（2026-08-12）：** 状态：进行中（已发现官方最新稳定版 `v0.1.175`，尚未准备、合并、推送、部署或线上验证）。用户要求立即从当前生产版本升级到官方最新版本。只读核对确认官方 GitHub Release `v0.1.175` 于 `2026-08-12T11:07:29Z` 发布，annotated tag object 为 `b898c60c422d1de059968c56aca22f6643f1fed4`，包含 Linux amd64/arm64 资产和 `checksums.txt`；Linux amd64 SHA-256 为 `690b99607b6e318bc667ccf3593cc7059ccc9f91cd27706e52e8bfb83004fd4e`，Linux arm64 SHA-256 为 `cf0e643d6241038b94fd045d790c658513437cc31853e76dc44989ba4679650a`。当前生产版本依据既有验收记录为 `0.1.173`。本轮当前工作区为根目录 `main@938017ba9`，相对 `origin/main` 本地领先 1 个总账提交；非 `main` worktree `codex/t03-r1-upstream-cost-persistence@ce5691527` 与 `codex/upstream-resilience-hardening@938017ba9` 已盘点并保留，未修改、未合并、未清理。根据 `docs/project/native-sub-incremental-delivery-constraints.md` 与 `docs/project/native-sub-task-package-queue.md`，T03-R1 必须先由用户可见独立顶层任务完成上游扣费异步持久化、部署和线上验收，在此之前禁止启动官方升级或 T05；因此本轮停在升级前置门禁，未触碰生产。
