...
func init() {
	...
	channelmonitorDescHistoryStartedAt := channelmonitorFields[15].Descriptor()
	...
	// groupDescActiveProbeEnabled is the schema descriptor for active_probe_enabled field.
