export default {
    ...
    users: {
      ...
      currentSpendableBalance: 'Available Quota',
      refundableCashBalance: 'Available Accounting Refund',
      paidQuota: 'Recharge Quota',
      accountingRefund: 'Accounting Refund',
      paymentChannelRefund: 'Payment Channel Refund',
      refundTradeNo: 'Refund Transaction No.',
      accountingRefundHint: 'A unique refund transaction number is required.',
      confirmAccountingRefund: 'Confirm Accounting Refund',
      noRefundableOrders: 'No refundable orders',
