    ...
    <section className="value-band grid-surface stack-panel" id="value" aria-labelledby="value-title">
      <div className="section-inner">
        <Reveal as="header" className="section-intro">
          ...
          <h2 id="value-title"><span className="mask-line"><span>国内直连、透明价格、真实模型</span></span></h2>
          <p>不绕远路，不隐藏折扣。每一条承诺都写清楚边界。</p>
        </Reveal>

        <div className="value-grid">
          <Reveal as="article" animation="scale-in" className="value-card value-card--wide model-card">
          ...
          <Reveal as="article" animation="scale-in" delay={180} className="value-card price-card">
          ...
          <Reveal as="article" animation="scale-in" delay={270} className="value-card channel-card">
          ...
          <Reveal as="article" animation="scale-in" delay={360} className="value-card value-card--wide network-card">
