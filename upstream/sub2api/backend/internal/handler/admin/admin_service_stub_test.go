...
func (s *stubAdminService) UpdateUserBalance(ctx context.Context, userID int64, balance float64, operation string, notes string, operatorID int64, idempotencyKey string) (*service.User, error) {
