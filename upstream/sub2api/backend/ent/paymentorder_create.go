...
func (_c *PaymentOrderCreate) SetNillablePaidQuotaUsd(v *decimal.Decimal) *PaymentOrderCreate {
	if v != nil {
...
func (_c *PaymentOrderCreate) SetGiftQuotaUsd(v decimal.Decimal) *PaymentOrderCreate {
	_c.mutation.SetGiftQuotaUsd(v)
	return _c
}

// SetNillableGiftQuotaUsd sets the "gift_quota_usd" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableGiftQuotaUsd(v *decimal.Decimal) *PaymentOrderCreate {
	if v != nil {
...
func (_c *PaymentOrderCreate) SetTotalQuotaUsd(v decimal.Decimal) *PaymentOrderCreate {
	_c.mutation.SetTotalQuotaUsd(v)
	return _c
}

// SetNillableTotalQuotaUsd sets the "total_quota_usd" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableTotalQuotaUsd(v *decimal.Decimal) *PaymentOrderCreate {
	if v != nil {
...
func (_c *PaymentOrderCreate) SetQuotaRuleSnapshot(v map[string]interface{}) *PaymentOrderCreate {
	_c.mutation.SetQuotaRuleSnapshot(v)
	return _c
}

// SetRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field.
func (_c *PaymentOrderCreate) SetRefundedPaidQuotaUsd(v decimal.Decimal) *PaymentOrderCreate {
...
func (_c *PaymentOrderCreate) SetNillableRefundedPaidQuotaUsd(v *decimal.Decimal) *PaymentOrderCreate {
	if v != nil {
...
func (_c *PaymentOrderCreate) SetQuotaAccountingStatus(v string) *PaymentOrderCreate {
	_c.mutation.SetQuotaAccountingStatus(v)
	return _c
}

// SetNillableQuotaAccountingStatus sets the "quota_accounting_status" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableQuotaAccountingStatus(v *string) *PaymentOrderCreate {
	if v != nil {
		_c.SetQuotaAccountingStatus(*v)
	}
	return _c
}

// SetOperatorUserID sets the "operator_user_id" field.
func (_c *PaymentOrderCreate) SetOperatorUserID(v int64) *PaymentOrderCreate {
	_c.mutation.SetOperatorUserID(v)
	return _c
}

// SetNillableOperatorUserID sets the "operator_user_id" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableOperatorUserID(v *int64) *PaymentOrderCreate {
	if v != nil {
...
func (_c *PaymentOrderCreate) SetOperatorNote(v string) *PaymentOrderCreate {
	_c.mutation.SetOperatorNote(v)
	return _c
}

// SetNillableOperatorNote sets the "operator_note" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableOperatorNote(v *string) *PaymentOrderCreate {
	if v != nil {
		_c.SetOperatorNote(*v)
	}
	return _c
}

// SetOperatorRechargedAt sets the "operator_recharged_at" field.
func (_c *PaymentOrderCreate) SetOperatorRechargedAt(v time.Time) *PaymentOrderCreate {
	_c.mutation.SetOperatorRechargedAt(v)
	return _c
}

// SetNillableOperatorRechargedAt sets the "operator_recharged_at" field if the given value is not nil.
func (_c *PaymentOrderCreate) SetNillableOperatorRechargedAt(v *time.Time) *PaymentOrderCreate {
	if v != nil {
		_c.SetOperatorRechargedAt(*v)
	}
	return _c
}
...
func (_c *PaymentOrderCreate) AddQuotaGrantIDs(ids ...int64) *PaymentOrderCreate {
	_c.mutation.AddQuotaGrantIDs(ids...)
	return _c
}

// AddQuotaGrants adds the "quota_grants" edges to the UserQuotaGrant entity.
func (_c *PaymentOrderCreate) AddQuotaGrants(v ...*UserQuotaGrant) *PaymentOrderCreate {
...
func (_c *PaymentOrderCreate) AddQuotaAdjustmentIDs(ids ...int64) *PaymentOrderCreate {
...
func (_c *PaymentOrderCreate) AddQuotaAdjustments(v ...*UserQuotaAdjustment) *PaymentOrderCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *PaymentOrderCreate) defaults() {
	...
	if _, ok := _c.mutation.GiftQuotaUsd(); !ok {
		v := paymentorder.DefaultGiftQuotaUsd
		_c.mutation.SetGiftQuotaUsd(v)
	}
	if _, ok := _c.mutation.TotalQuotaUsd(); !ok {
		v := paymentorder.DefaultTotalQuotaUsd
		_c.mutation.SetTotalQuotaUsd(v)
	}
	if _, ok := _c.mutation.RefundedPaidQuotaUsd(); !ok {
		v := paymentorder.DefaultRefundedPaidQuotaUsd
		_c.mutation.SetRefundedPaidQuotaUsd(v)
	}
	if _, ok := _c.mutation.QuotaAccountingStatus(); !ok {
		v := paymentorder.DefaultQuotaAccountingStatus
		_c.mutation.SetQuotaAccountingStatus(v)
	}
...
func (_c *PaymentOrderCreate) check() error {
	...
	if _, ok := _c.mutation.GiftQuotaUsd(); !ok {
		return &ValidationError{Name: "gift_quota_usd", err: errors.New(`ent: missing required field "PaymentOrder.gift_quota_usd"`)}
	}
	if _, ok := _c.mutation.TotalQuotaUsd(); !ok {
		return &ValidationError{Name: "total_quota_usd", err: errors.New(`ent: missing required field "PaymentOrder.total_quota_usd"`)}
	}
	if _, ok := _c.mutation.QuotaRuleSnapshot(); !ok {
		return &ValidationError{Name: "quota_rule_snapshot", err: errors.New(`ent: missing required field "PaymentOrder.quota_rule_snapshot"`)}
	}
	if _, ok := _c.mutation.RefundedPaidQuotaUsd(); !ok {
		return &ValidationError{Name: "refunded_paid_quota_usd", err: errors.New(`ent: missing required field "PaymentOrder.refunded_paid_quota_usd"`)}
	}
	if _, ok := _c.mutation.QuotaAccountingStatus(); !ok {
		return &ValidationError{Name: "quota_accounting_status", err: errors.New(`ent: missing required field "PaymentOrder.quota_accounting_status"`)}
	}
	if v, ok := _c.mutation.QuotaAccountingStatus(); ok {
...
func (_c *PaymentOrderCreate) createSpec() (*PaymentOrder, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.QuotaRuleSnapshot(); ok {
		_spec.SetField(paymentorder.FieldQuotaRuleSnapshot, field.TypeJSON, value)
		_node.QuotaRuleSnapshot = value
	}
	...
	if value, ok := _c.mutation.QuotaAccountingStatus(); ok {
		_spec.SetField(paymentorder.FieldQuotaAccountingStatus, field.TypeString, value)
		_node.QuotaAccountingStatus = value
	}
...
// SetPaidQuotaUsd sets the "paid_quota_usd" field.
func (u *PaymentOrderUpsert) SetPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldPaidQuotaUsd, v)
	return u
}

// UpdatePaidQuotaUsd sets the "paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdatePaidQuotaUsd() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldPaidQuotaUsd)
	return u
}

// SetGiftQuotaUsd sets the "gift_quota_usd" field.
func (u *PaymentOrderUpsert) SetGiftQuotaUsd(v decimal.Decimal) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldGiftQuotaUsd, v)
	return u
}

// UpdateGiftQuotaUsd sets the "gift_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateGiftQuotaUsd() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldGiftQuotaUsd)
	return u
}

// SetTotalQuotaUsd sets the "total_quota_usd" field.
func (u *PaymentOrderUpsert) SetTotalQuotaUsd(v decimal.Decimal) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldTotalQuotaUsd, v)
	return u
}

// UpdateTotalQuotaUsd sets the "total_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateTotalQuotaUsd() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldTotalQuotaUsd)
	return u
}

// SetQuotaRuleSnapshot sets the "quota_rule_snapshot" field.
func (u *PaymentOrderUpsert) SetQuotaRuleSnapshot(v map[string]interface{}) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldQuotaRuleSnapshot, v)
	return u
}

// UpdateQuotaRuleSnapshot sets the "quota_rule_snapshot" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateQuotaRuleSnapshot() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldQuotaRuleSnapshot)
	return u
}

// SetRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field.
func (u *PaymentOrderUpsert) SetRefundedPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldRefundedPaidQuotaUsd, v)
	return u
}

// UpdateRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateRefundedPaidQuotaUsd() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldRefundedPaidQuotaUsd)
	return u
}

// SetQuotaAccountingStatus sets the "quota_accounting_status" field.
func (u *PaymentOrderUpsert) SetQuotaAccountingStatus(v string) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldQuotaAccountingStatus, v)
	return u
}

// UpdateQuotaAccountingStatus sets the "quota_accounting_status" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateQuotaAccountingStatus() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldQuotaAccountingStatus)
	return u
}

// SetOperatorUserID sets the "operator_user_id" field.
func (u *PaymentOrderUpsert) SetOperatorUserID(v int64) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldOperatorUserID, v)
	return u
}

// UpdateOperatorUserID sets the "operator_user_id" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateOperatorUserID() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldOperatorUserID)
	return u
}

// AddOperatorUserID adds v to the "operator_user_id" field.
func (u *PaymentOrderUpsert) AddOperatorUserID(v int64) *PaymentOrderUpsert {
	u.Add(paymentorder.FieldOperatorUserID, v)
	return u
}

// ClearOperatorUserID clears the value of the "operator_user_id" field.
func (u *PaymentOrderUpsert) ClearOperatorUserID() *PaymentOrderUpsert {
	u.SetNull(paymentorder.FieldOperatorUserID)
	return u
}

// SetOperatorNote sets the "operator_note" field.
func (u *PaymentOrderUpsert) SetOperatorNote(v string) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldOperatorNote, v)
	return u
}

// UpdateOperatorNote sets the "operator_note" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateOperatorNote() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldOperatorNote)
	return u
}

// ClearOperatorNote clears the value of the "operator_note" field.
func (u *PaymentOrderUpsert) ClearOperatorNote() *PaymentOrderUpsert {
	u.SetNull(paymentorder.FieldOperatorNote)
	return u
}

// SetOperatorRechargedAt sets the "operator_recharged_at" field.
func (u *PaymentOrderUpsert) SetOperatorRechargedAt(v time.Time) *PaymentOrderUpsert {
	u.Set(paymentorder.FieldOperatorRechargedAt, v)
	return u
}

// UpdateOperatorRechargedAt sets the "operator_recharged_at" field to the value that was provided on create.
func (u *PaymentOrderUpsert) UpdateOperatorRechargedAt() *PaymentOrderUpsert {
	u.SetExcluded(paymentorder.FieldOperatorRechargedAt)
	return u
}

// ClearOperatorRechargedAt clears the value of the "operator_recharged_at" field.
func (u *PaymentOrderUpsert) ClearOperatorRechargedAt() *PaymentOrderUpsert {
	u.SetNull(paymentorder.FieldOperatorRechargedAt)
	return u
}
...
// SetPaidQuotaUsd sets the "paid_quota_usd" field.
func (u *PaymentOrderUpsertOne) SetPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetPaidQuotaUsd(v)
	})
}
...
// UpdatePaidQuotaUsd sets the "paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdatePaidQuotaUsd() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetGiftQuotaUsd sets the "gift_quota_usd" field.
func (u *PaymentOrderUpsertOne) SetGiftQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetGiftQuotaUsd(v)
	})
}
...
// UpdateGiftQuotaUsd sets the "gift_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateGiftQuotaUsd() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetTotalQuotaUsd sets the "total_quota_usd" field.
func (u *PaymentOrderUpsertOne) SetTotalQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// UpdateTotalQuotaUsd sets the "total_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateTotalQuotaUsd() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetQuotaRuleSnapshot sets the "quota_rule_snapshot" field.
func (u *PaymentOrderUpsertOne) SetQuotaRuleSnapshot(v map[string]interface{}) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetQuotaRuleSnapshot(v)
	})
}

// UpdateQuotaRuleSnapshot sets the "quota_rule_snapshot" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateQuotaRuleSnapshot() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateQuotaRuleSnapshot()
	})
}

// SetRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field.
func (u *PaymentOrderUpsertOne) SetRefundedPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// UpdateRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateRefundedPaidQuotaUsd() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetQuotaAccountingStatus sets the "quota_accounting_status" field.
func (u *PaymentOrderUpsertOne) SetQuotaAccountingStatus(v string) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetQuotaAccountingStatus(v)
	})
}

// UpdateQuotaAccountingStatus sets the "quota_accounting_status" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateQuotaAccountingStatus() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateQuotaAccountingStatus()
	})
}

// SetOperatorUserID sets the "operator_user_id" field.
func (u *PaymentOrderUpsertOne) SetOperatorUserID(v int64) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// AddOperatorUserID adds v to the "operator_user_id" field.
func (u *PaymentOrderUpsertOne) AddOperatorUserID(v int64) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// UpdateOperatorUserID sets the "operator_user_id" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateOperatorUserID() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// ClearOperatorUserID clears the value of the "operator_user_id" field.
func (u *PaymentOrderUpsertOne) ClearOperatorUserID() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
...
// SetOperatorNote sets the "operator_note" field.
func (u *PaymentOrderUpsertOne) SetOperatorNote(v string) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetOperatorNote(v)
	})
}
...
// UpdateOperatorNote sets the "operator_note" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateOperatorNote() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateOperatorNote()
	})
}

// ClearOperatorNote clears the value of the "operator_note" field.
func (u *PaymentOrderUpsertOne) ClearOperatorNote() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.ClearOperatorNote()
	})
}
...
// SetOperatorRechargedAt sets the "operator_recharged_at" field.
func (u *PaymentOrderUpsertOne) SetOperatorRechargedAt(v time.Time) *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetOperatorRechargedAt(v)
	})
}

// UpdateOperatorRechargedAt sets the "operator_recharged_at" field to the value that was provided on create.
func (u *PaymentOrderUpsertOne) UpdateOperatorRechargedAt() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateOperatorRechargedAt()
	})
}

// ClearOperatorRechargedAt clears the value of the "operator_recharged_at" field.
func (u *PaymentOrderUpsertOne) ClearOperatorRechargedAt() *PaymentOrderUpsertOne {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.ClearOperatorRechargedAt()
	})
}
...
// SetPaidQuotaUsd sets the "paid_quota_usd" field.
func (u *PaymentOrderUpsertBulk) SetPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetPaidQuotaUsd(v)
	})
}
...
// UpdatePaidQuotaUsd sets the "paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdatePaidQuotaUsd() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdatePaidQuotaUsd()
	})
}
...
// SetGiftQuotaUsd sets the "gift_quota_usd" field.
func (u *PaymentOrderUpsertBulk) SetGiftQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetGiftQuotaUsd(v)
	})
}
...
// UpdateGiftQuotaUsd sets the "gift_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateGiftQuotaUsd() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateGiftQuotaUsd()
	})
}
...
// SetTotalQuotaUsd sets the "total_quota_usd" field.
func (u *PaymentOrderUpsertBulk) SetTotalQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetTotalQuotaUsd(v)
	})
}
...
// UpdateTotalQuotaUsd sets the "total_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateTotalQuotaUsd() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateTotalQuotaUsd()
	})
}
...
// SetQuotaRuleSnapshot sets the "quota_rule_snapshot" field.
func (u *PaymentOrderUpsertBulk) SetQuotaRuleSnapshot(v map[string]interface{}) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetQuotaRuleSnapshot(v)
	})
}
...
// UpdateQuotaRuleSnapshot sets the "quota_rule_snapshot" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateQuotaRuleSnapshot() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateQuotaRuleSnapshot()
	})
}
...
// SetRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field.
func (u *PaymentOrderUpsertBulk) SetRefundedPaidQuotaUsd(v decimal.Decimal) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetRefundedPaidQuotaUsd(v)
	})
}
...
// UpdateRefundedPaidQuotaUsd sets the "refunded_paid_quota_usd" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateRefundedPaidQuotaUsd() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateRefundedPaidQuotaUsd()
	})
}
...
// SetQuotaAccountingStatus sets the "quota_accounting_status" field.
func (u *PaymentOrderUpsertBulk) SetQuotaAccountingStatus(v string) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetQuotaAccountingStatus(v)
	})
}
...
// UpdateQuotaAccountingStatus sets the "quota_accounting_status" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateQuotaAccountingStatus() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateQuotaAccountingStatus()
	})
}
...
// SetOperatorUserID sets the "operator_user_id" field.
func (u *PaymentOrderUpsertBulk) SetOperatorUserID(v int64) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetOperatorUserID(v)
	})
}
...
// AddOperatorUserID adds v to the "operator_user_id" field.
func (u *PaymentOrderUpsertBulk) AddOperatorUserID(v int64) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.AddOperatorUserID(v)
	})
}
...
// UpdateOperatorUserID sets the "operator_user_id" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateOperatorUserID() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateOperatorUserID()
	})
}
...
// ClearOperatorUserID clears the value of the "operator_user_id" field.
func (u *PaymentOrderUpsertBulk) ClearOperatorUserID() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.ClearOperatorUserID()
	})
}
...
// SetOperatorNote sets the "operator_note" field.
func (u *PaymentOrderUpsertBulk) SetOperatorNote(v string) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetOperatorNote(v)
	})
}
...
// UpdateOperatorNote sets the "operator_note" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateOperatorNote() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateOperatorNote()
	})
}
...
// ClearOperatorNote clears the value of the "operator_note" field.
func (u *PaymentOrderUpsertBulk) ClearOperatorNote() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.ClearOperatorNote()
	})
}
...
// SetOperatorRechargedAt sets the "operator_recharged_at" field.
func (u *PaymentOrderUpsertBulk) SetOperatorRechargedAt(v time.Time) *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.SetOperatorRechargedAt(v)
	})
}
...
// UpdateOperatorRechargedAt sets the "operator_recharged_at" field to the value that was provided on create.
func (u *PaymentOrderUpsertBulk) UpdateOperatorRechargedAt() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.UpdateOperatorRechargedAt()
	})
}
...
// ClearOperatorRechargedAt clears the value of the "operator_recharged_at" field.
func (u *PaymentOrderUpsertBulk) ClearOperatorRechargedAt() *PaymentOrderUpsertBulk {
	return u.Update(func(s *PaymentOrderUpsert) {
		s.ClearOperatorRechargedAt()
	})
}
