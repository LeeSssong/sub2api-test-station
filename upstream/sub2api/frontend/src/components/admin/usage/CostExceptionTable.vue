    ...
    <div class="overflow-x-auto">
      <table class="min-w-full text-sm">
        ...
        <tbody>
          ...
          <tr v-else-if="loadError" data-test="cost-exceptions-error"><td colspan="13" class="p-8 text-center"><p class="text-red-600 dark:text-red-400">{{ loadError }}</p><button class="btn btn-secondary mt-3" data-test="cost-exceptions-retry" @click="reload">{{ t('common.retry') }}</button></td></tr>
