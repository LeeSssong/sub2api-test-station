export default {
    accounts: {
      ...
      modelDetection: {
        title: 'Account model detection', close: 'Close', connectionProbeModel: 'Connection test model', detectionModel: 'Detection model', detectorUnsupported: 'Detector not supported', detectorUnconfigured: 'Detection service not connected', detectorUnavailable: 'Detection service temporarily unavailable',
        recentStatus: 'Latest status', historicalFallback: 'Current evidence is insufficient; showing the latest final detection result', declaredModel: 'Declared model', requestedModel: 'Requested model', upstreamResponseModel: 'Upstream response model', upstreamModelMissing: 'Upstream did not return a model field', activeResponseUnavailable: 'Active response unavailable', catalogEvidence: 'Model catalog', catalogMatch: 'Requested model advertised', catalogMissing: 'Requested model not advertised', catalogUnavailable: 'Model catalog unavailable', catalogReturned: 'Catalog returned {count} model(s): {models}', fingerprintEvidence: 'Behavior fingerprint', fingerprintMatch: 'Fingerprint matched', fingerprintMismatch: 'Fingerprint candidate: {candidate} ({similarity})', fingerprintUnavailable: 'Behavior fingerprint not tested', technicalDetails: 'Technical details', juice: 'Juice', juiceSummary: 'Juice summary', fingerprintCandidate: 'Behavior fingerprint candidate', fingerprintSimilarity: 'Similarity', detectorVersion: 'Detector version', detectionTime: 'Detection time', error: 'Error',
        historyEyebrow: 'MODEL EVIDENCE', historySummaryTitle: 'Account detection timeline', historySummaryHint: 'Review each run by coverage tier, evidence sample count, and trigger.', historyCountSuffix: ' records', statusFilter: 'Conclusion', profileFilter: 'Coverage tier', juiceFilter: 'Juice result', fingerprintFilter: 'Fingerprint result', conclusionFilter: 'Overall conclusion', profileAndSamples: 'Tier and samples', fingerprintShort: 'Fingerprint', historyDetailsHint: 'Select a record to expand its evidence details', time: 'Detection time', statusLabel: 'Conclusion', evidenceUnavailable: 'Evidence unavailable', samplesUnavailable: 'Historical record', historicalRecordHint: 'Historical record: legacy rows have no tier or sample detail',
        profileNames: { low: 'Low · quick screen', medium: 'Medium · routine monitor', high: 'High · deep review', unknown: 'Historical record' },
        modeNames: { monitor: 'Routine monitor', manual: 'Manual review', escalation: 'Escalation', historical: 'Historical' },
        reasonValue: { scheduled: 'Scheduled', manual: 'Manual trigger', first_run: 'First baseline', consecutive_abnormal: 'Consecutive anomaly', insufficient: 'Consecutive insufficient evidence', model_conflict: 'Model conflict', suspicious: 'Suspicious evidence' },
        verdict: { verified: 'Model verified', suspected_mapping: 'Suspected model mapping', suspected_replacement: 'Suspected model replacement', high_risk_inconsistent: 'High-risk inconsistent evidence', insufficient: 'Insufficient evidence' },
        juiceStatus: { pass: 'Passed', mismatch: 'Mismatch with declared model', insufficient: 'Insufficient evidence', non_gpt: 'Possibly non-GPT', unavailable: 'Evidence unavailable' },
        fingerprintStatus: { strong_match: 'Strong indication', unclear: 'Evidence unclear', unavailable: 'No known fingerprint' },
        conclusion: { normal: 'Matches declaration', abnormal: 'Detection anomaly', insufficient: 'Insufficient evidence', failed: 'Detection failed' },
        juiceDetail: { pass: 'Every enabled tier has sufficient declared-model hits with no explicit conflict.', mismatch: 'Explicit evidence belongs to another known model and conflicts with the declaration.', insufficient: 'At least one enabled tier lacks sufficient valid hits.', non_gpt: 'Juice did not form a known GPT fingerprint.', unavailable: 'No usable Juice evidence was obtained.' },
        fingerprintDetail: { strong_match: 'Exactly one model strictly exceeds the current tier threshold and the runtime contract matches.', unclear: 'Samples are insufficient, no model crossed the threshold, or multiple models crossed it.', unavailable: 'No usable behavior-fingerprint evidence was obtained.' },
        fingerprintCandidateDetail: 'Current evidence strongly indicates {candidate}.',
        abnormalDisclaimer: 'The detector observed an anomaly; this does not mean the upstream confirmed a replacement.', saveModels: 'Save models', detecting: 'Queued…', detectNow: 'Detect now', section: 'Model detection', editConnectionProbeModel: 'Change connection test model', viewRecent: 'View detection history', historyTitle: 'Detection history', historyEmpty: 'No detection records', historyLoadError: 'Failed to load detection history', loadMore: 'Load more', loading: 'Loading', profile: 'Profile', mode: 'Mode', reason: 'Trigger reason', samples: 'Valid samples', fingerprint: 'Behavior fingerprint', details: 'View details', historical: 'Historical record', observedAbnormal: 'Detector observed an anomaly',
        status: { untested: 'Not tested', queued: 'Queued', running: 'Running', normal: 'Normal', abnormal: 'Anomaly', insufficient: 'Insufficient evidence', failed: 'Detection failed', unsupported: 'Unsupported', service_unconfigured: 'Detection service not connected', service_unavailable: 'Detection service temporarily unavailable' }
      },
      monitor: { historyFallback: 'Score carried from the latest valid result', historyFallbackAt: 'Historical final result time' },
