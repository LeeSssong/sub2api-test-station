...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subUpstreamCostService := service.NewSubUpstreamCostService(usageService)
	adminUsageHandler := admin.NewUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, subUpstreamCostService)
	...
	accountFinancialActivationRepository := repository.NewAccountFinancialActivationRepository(db)
	usageCostEvidenceRegistrar := service.NewUsageCostEvidenceRegistrar(usageLogRepository, usageCostEvidenceRepository, accountFinancialActivationRepository)
