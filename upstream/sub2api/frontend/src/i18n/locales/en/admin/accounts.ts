export default {
    accounts: {
      ...
      modelDetection: {
        ...
        historyEyebrow: 'MODEL EVIDENCE', historySummaryTitle: 'Account detection timeline', historySummaryHint: 'Review each run by coverage tier, evidence sample count, and trigger.', historyCountSuffix: ' records', statusFilter: 'Conclusion', profileFilter: 'Coverage tier', time: 'Time', statusLabel: 'Conclusion', evidenceUnavailable: 'Evidence unavailable', samplesUnavailable: 'Historical record', historicalRecordHint: 'Historical record: legacy rows have no tier or sample detail',
