...
**T07 全局评分设置（2026-08-15）：** 状态：进行中，`BLOCKED`（已合并、已推送、生产未变）。用户可见顶层任务 `01a0018d-65fa-7dd2-9393-31d9e1643adc` 已完成完整规格/计划、TDD、逐任务独立复审、全分支审查及两轮异步竞态修复复审；最终候选 `f26892107ebe19af392c643dc5f60a7e194e4d57` 经根授权合并为 `main@8b04ae4733ac48616c77737d05c410dd64c39e45`、tree `a04a9bdaf2838ba5f5e4e017411507427b1dbdf9`，并已推送 `origin/main`。合并后后端迁移/repository/service/admin-handler/routes、server build、真实 PostgreSQL `TestMigrationsSchema`、前端 49/49、typecheck、production build 和 diff-check 均通过；`0600` 发布证据为 `/Users/gongtengxinwen/.codex/release-evidence/sub2api/2026-08-15-main-8b04ae473-t07-global-score-weights-v1.json`。候选新增 expand-only migration 223，完整迁移哈希 `d3fe99bba69b0cf0cca8a7f5ec45499921f3496f58dd74c3a671d90a653589b5` 与生产 `6a0e141eb4788460a99fc3e108ce5b46c866fd2c45b9a7265ea66b0ef8faaf71` 不同；只读生产状态核对确认活动槽仍为 `green`、source `459a020fd99b605c3da50ead2cbc10121e57cbcd`。发布门禁结论为 `downtime_required=true`、`reason_code=migration_set_changed`、预计不可用上限 300 秒；已在构建传输、停服、迁移、重启和切流前停止，等待用户本次明确停机确认。T08 未启动，T07 worktree/分支保留。
