export default {
    accounts: {
      ...
      billingRateMultiplierPolicy: '计费倍率控制',
      billingRateMultiplierPolicyManaged: '跟随上游计费管理',
      billingRateMultiplierPolicyManual: '手动覆盖',
      billingRateMultiplierPolicyHint: '跟随上游时，下次计费探测可以更新倍率。',
      expiresAt: '过期时间',
