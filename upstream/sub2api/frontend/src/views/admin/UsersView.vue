<template>
  <AppLayout>
    ...
    <UserBalanceHistoryModal :show="showBalanceHistoryModal" :user="balanceHistoryUser" @close="closeBalanceHistoryModal" @gift="handleDepositFromHistory" @deduct="handleWithdrawFromHistory" />
