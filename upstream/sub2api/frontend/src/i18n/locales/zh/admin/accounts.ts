export default {
    accounts: {
      ...
      modelDetection: {
        ...
        historyEyebrow: 'MODEL EVIDENCE', historySummaryTitle: '账号级检测轨迹', historySummaryHint: '按时间查看每次检测的覆盖档位、证据样本与触发原因。', historyCountSuffix: ' 条记录', statusFilter: '结论', profileFilter: '覆盖档位', time: '时间', statusLabel: '结论', evidenceUnavailable: '未取得证据', samplesUnavailable: '历史记录', historicalRecordHint: '历史记录：旧格式未保存档位与样本明细',
