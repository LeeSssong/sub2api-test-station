export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        topKLabel: 'TopK',
        topKHint: 'Number of highest-scoring candidates kept per request. Smaller values reduce probing cost but can starve lower-scoring accounts; fairness modes may add an overdue account.',
        priorityWeight: 'Priority',
        priorityWeightHint: 'Weight for account priority. Higher values prefer lower numeric priority values; 0 disables this factor.',
        loadWeight: 'Load',
        loadWeightHint: 'Weight for current concurrency load. Higher values avoid busy accounts and reduce single-account concentration.',
        queueWeight: 'Queue',
        queueWeightHint: 'Weight for waiting queue length. Higher values prefer accounts with shorter queues.',
        errorRateWeight: 'Error rate',
        errorRateWeightHint: 'Weight for recent error rate. Higher values avoid accounts with more failures.',
        ttftWeight: 'TTFT',
        ttftWeightHint: 'Weight for recent time-to-first-token. Higher values prefer faster accounts.',
        resetWeight: 'Reset window',
        resetWeightHint: 'Weight for accounts near a session-window reset. Higher values consume expiring capacity first; 0 disables it.',
        quotaHeadroomWeight: 'Quota headroom',
        quotaHeadroomWeightHint: 'Weight for remaining quota. Higher values prefer accounts with more headroom; 0 disables it.',
        upstreamCostWeight: 'Billing rate',
        upstreamCostWeightHint: 'Weight for upstream billing rate. Higher values prefer lower-rate accounts; 0 ignores rate.',
        previousResponseWeight: 'previous_response sticky',
        previousResponseWeightHint: 'Weight for previous_response_id affinity. Higher values reuse the original account and reduce context moves.',
        sessionStickyWeight: 'session_hash sticky',
        sessionStickyWeightHint: 'Weight for session_hash affinity. Higher values keep a session on the same account.',
