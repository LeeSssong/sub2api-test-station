...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountMonitorService := service.ProvideAccountMonitorService(accountMonitorRepository, accountRepository, accountRepository, accountTestService, accountUsageService, billingService, upstreamBillingProbeService)
