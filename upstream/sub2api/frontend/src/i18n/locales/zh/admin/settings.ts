export default {
    settings: {
      ...
      openaiExperimentalScheduler: {
        ...
        topKLabel: 'TopK',
        topKHint: '每次先保留得分最高的候选数；数值越小越省探测开销，但可能长期忽略低分账号。公平模式仍可把长期未用账号加入候选。',
        priorityWeight: '优先级',
        priorityWeightHint: '账号 priority 的权重；越大越偏向优先级数字更小的账号，0 表示不参与排序。',
        loadWeight: '负载',
        loadWeightHint: '当前并发负载权重；越大越避开高负载账号，降低单账号拥塞。',
        queueWeight: '排队',
        queueWeightHint: '等待队列权重；越大越优先选择排队更短的账号。',
        errorRateWeight: '错误率',
        errorRateWeightHint: '近期错误率权重；越大越避开错误率高的账号。',
        ttftWeight: '首包延迟',
        ttftWeightHint: '近期首 token 延迟权重；越大越偏向响应更快的账号。',
        resetWeight: '重置窗口',
        resetWeightHint: '会话窗口即将重置的权重；越大越优先消耗临近重置的额度，0 表示关闭。',
        quotaHeadroomWeight: '额度余量',
        quotaHeadroomWeightHint: '额度余量权重；越大越偏向剩余额度更充足的账号，0 表示关闭。',
        upstreamCostWeight: '计费倍率',
        upstreamCostWeightHint: '上游计费倍率权重；越大越偏向低倍率账号，0 表示不考虑倍率。',
        previousResponseWeight: 'previous_response 粘性',
        previousResponseWeightHint: 'previous_response_id 粘性权重；越大越优先复用原账号，减少上下文迁移。',
        sessionStickyWeight: 'session_hash 粘性',
        sessionStickyWeightHint: 'session_hash 粘性权重；越大越优先复用同一会话账号。',
        fairnessTitle: '公平调度',
