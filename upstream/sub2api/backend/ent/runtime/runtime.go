...
func init() {
	...
	usagelogDescLogicalRequestID := usagelogFields[4].Descriptor()
	...
	usagelogDescAttemptID := usagelogFields[5].Descriptor()
	...
	usagelogDescUsageCompleteness := usagelogFields[6].Descriptor()
	...
	usagelogDescReconciliationRequired := usagelogFields[7].Descriptor()
	...
	usagelogDescUnsafeToReplay := usagelogFields[8].Descriptor()
	...
	usagelogDescActualResponseModel := usagelogFields[12].Descriptor()
