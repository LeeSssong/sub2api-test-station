...
const { t } = useI18n(); const currentWindow = ref<MonitorV4Window>('24h'); const loading = ref(true); const snapshot = ref<MonitorV4Snapshot>({ contract_version:'1', window:'24h', refresh_interval_seconds:60, generated_at:new Date().toISOString(), groups:[] }); let controller: AbortController | null = null; let timer: number | null = null
