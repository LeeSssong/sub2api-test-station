...
function onLeave(event: MouseEvent) {
  ...
  if (props.trigger === 'hover' && isInside(tooltipRef.value, event.relatedTarget)) return
  closeTooltip()
}
    ...
    <Teleport to="body">
      <div
        ...
        :class="[
          ...
          'selection:bg-primary-200 selection:text-gray-900 before:absolute before:inset-x-0 before:top-full before:h-3',
