...
func TestUsageLogRepositoryListOpenAIAccountQualityCombinesUsageAndAccountOwnedErrors(t *testing.T) {
	...
	mock.ExpectQuery("quality").
		...
		WillReturnRows(sqlmock.NewRows([]string{
			...
			AddRow(int64(7), "w5", int64(2), int64(1), 0.5, int64(1), 1200.0, 1800.0, int64(1), 25.0).
			AddRow(int64(7), "w55", int64(10), int64(9), 0.9, int64(8), 800.0, 1400.0, int64(7), 40.0).
			AddRow(int64(8), "w55", int64(1), int64(0), 0.0, int64(0), nil, nil, int64(0), nil))
	...
	require.Equal(t, []service.OpenAIAccountQuality{
		{AccountID: 7, Windows: map[service.OpenAIQualityWindow]service.OpenAIQualityWindowMetrics{
			service.OpenAIQualityWindow5M:  {AttemptCount: 2, SuccessCount: 1, SuccessRate: qualityFloatPtr(0.5), TTFTSampleCount: 1, TTFTP50MS: qualityFloatPtr(1200), TTFTP90MS: qualityFloatPtr(1800), OutputRateSampleCount: 1, OutputRateTokensPerSecond: qualityFloatPtr(25)},
			service.OpenAIQualityWindow55M: {AttemptCount: 10, SuccessCount: 9, SuccessRate: qualityFloatPtr(0.9), TTFTSampleCount: 8, TTFTP50MS: qualityFloatPtr(800), TTFTP90MS: qualityFloatPtr(1400), OutputRateSampleCount: 7, OutputRateTokensPerSecond: qualityFloatPtr(40)},
		}},
		{AccountID: 8, Windows: map[service.OpenAIQualityWindow]service.OpenAIQualityWindowMetrics{
			service.OpenAIQualityWindow55M: {AttemptCount: 1, SuccessCount: 0, SuccessRate: qualityFloatPtr(0)},
		}},
	}, got)
