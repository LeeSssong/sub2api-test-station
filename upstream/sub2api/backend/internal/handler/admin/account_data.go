...
type DataAccount struct {
	...
	RateMultiplierPolicy *string        `json:"rate_multiplier_policy,omitempty"`
...
func (h *AccountHandler) ExportData(c *gin.Context) {
	...
	for i := range accounts {
		...
		dataAccounts = append(dataAccounts, DataAccount{
			...
			RateMultiplierPolicy: func() *string {
				policy, valid := service.UpstreamBillingRateMultiplierPolicyFromExtra(acc.Extra)
				if !valid {
					return nil
				}
				return &policy
