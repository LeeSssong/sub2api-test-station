...
export default {
  channelMonitorV2: {
    hybrid: {
      ...
      ttftP95: 'First token P95', latencyP95: 'Total duration P95', cacheP95: 'Cache P95', requestCount: 'Success {success}/{total} requests', multiplier: 'Multiplier: {value}x', empty: 'No visible groups',
    },
