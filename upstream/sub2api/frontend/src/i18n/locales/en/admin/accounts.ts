export default {
    accounts: {
      ...
      modelDetection: {
        ...
        reasonValue: { scheduled: 'Scheduled', manual: 'Manual trigger', first_run: 'First baseline', consecutive_abnormal: 'Consecutive anomaly', insufficient: 'Consecutive insufficient evidence', model_conflict: 'Model conflict' },
