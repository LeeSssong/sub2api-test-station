...
- T07 已完成生产验收；T08 已完成规格书和计划书代审批准，当前处于 `IMPLEMENTING`。T08 仅允许修改计划中列明的前端文件与任务报告，不得修改全局队列/总账、后端、迁移、配置、生产或 GitHub Actions。S1 旧候选继续冻结。
