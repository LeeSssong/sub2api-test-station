<template>
  <BaseDialog :show="show" title="创建线路密钥" brand-theme panel-class="xq-key-dialog" :close-on-escape="!submitting" :show-close-button="!submitting" @close="close">
