...
CREATE TABLE IF NOT EXISTS user_wallets (
    ...
    -- Preserve legacy technical overdrafts until a later recharge repays them.
...
CREATE TABLE IF NOT EXISTS user_quota_ledger_entries (
    ...
    paid_before_usd       DECIMAL(20,8) NOT NULL DEFAULT 0,
    paid_after_usd        DECIMAL(20,8) NOT NULL DEFAULT 0,
