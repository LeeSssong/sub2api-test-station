...
class EvaluateModelReleaseReadinessTest < Minitest::Test
  ...
  def healthy_snapshot
    snapshot = {
      ...
      "base_configuration" => {
        "accounts" => [
          { "account_id" => 10, "model_mapping" => MODELS.first(3) },
          { "account_id" => 11, "model_mapping" => MODELS },
          { "account_id" => 12, "model_mapping" => MODELS.last(2) }
        ],
        "channels" => [
          { "channel_id" => 20, "group_ids" => [2], "models" => MODELS },
          { "channel_id" => 21, "group_ids" => [3], "models" => MODELS }
        ]
      }
    }
