...
type UsageLog struct {
	...
	// ActualResponseModel holds the value of the "actual_response_model" field.
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldActualResponseModel:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field actual_response_model", values[i])
			} else if value.Valid {
				_m.ActualResponseModel = new(string)
				*_m.ActualResponseModel = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ActualResponseModel; v != nil {
		builder.WriteString("actual_response_model=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
