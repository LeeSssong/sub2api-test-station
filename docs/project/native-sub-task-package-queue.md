...
- **T55 原生额度钱包与手动充值退款账本**：状态 `VERIFYING`（当前仅测试站）。2026-08-23T23:00Z 已将独立候选 `7766644aaf2e4eadccb6940a572664f68085dd4f` 切换到隔离 admin-lab，8 个隔离服务 healthy，并完成登录、用户列表、额度摘要、额度流水、充值、同键幂等重放和退款线上核验；主站 `main@5ba7a82b1fce468d032815217e032d8adbd84781` 未迁移、未重启、未切换。生产发布仍暂缓，待用户恢复主站范围后再按迁移停机门禁继续；T57 只能读取 T55 稳定契约，不能修改 T55 worktree。证据：`/Users/gongtengxinwen/.codex/release-evidence/sub2api/2026-08-24-t55-admin-lab-7766644aaf.json`。
