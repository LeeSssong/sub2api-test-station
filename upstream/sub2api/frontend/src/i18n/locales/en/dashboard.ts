export default {
  ...
  usage: {
    ...
    actualResponseModel: 'Actual Response Model',
    ...
    detail: {
      ...
      tokenSection: 'Token Details',
      billingSection: 'Billing Details',
      adminSection: 'Administrator Details',
      ...
      effectiveInputPrice: 'Effective Input Price',
      effectiveOutputPrice: 'Effective Output Price',
    ...
    tabs: { usage: 'Usage', errors: 'Error Requests', costExceptions: 'Cost Exceptions', ranking: 'User Ranking' },
    errors: {
