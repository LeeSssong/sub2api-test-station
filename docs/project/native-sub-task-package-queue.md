...
- 全局审计（2026-08-19）：根 `main`/`origin/main`/生产 release-state 已同步到 `3bc16ee2682e6e978f73a71099c010a8353f2064`，T27 已完成部署验收；非 `main` 仅保留待归档的 T27 worktree 与用户指定保护的 detached 视觉预览 `/private/tmp/sub2api-monitor-v3-preview`，根目录既有未跟踪资料继续保留。
