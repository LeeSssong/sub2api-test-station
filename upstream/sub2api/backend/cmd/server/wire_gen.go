...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamMultiplierMeasurementService := service.NewUpstreamMultiplierMeasurementService(accountRepository, accountTestService, billingService)
	accountMultiplierService := service.NewAccountMultiplierService(accountRepository, upstreamBillingProbeService, upstreamMultiplierMeasurementService)
	accountMonitorService := service.ProvideAccountMonitorService(accountMonitorRepository, accountRepository, accountTestService, accountUsageService, accountMultiplierService)
	accountMonitorRunner := service.ProvideAccountMonitorRunner(accountMonitorService)
