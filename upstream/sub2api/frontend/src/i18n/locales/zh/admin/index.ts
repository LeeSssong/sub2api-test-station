...
export default {
  ...
  schedulerSettings: {
    ...
    guardTitle: '服务不中断',
    guardDescription: '资格、并发、冷却与健康检查始终优先；所有候选仍需经过原子抢槽和复核。',
    fixed: '固定护栏',
    priorities: '经营优先顺序',
    prioritiesHint: '数字 1 最高、3 最低；相同数字表示同等重视。',
    profit: '利润',
    ttft: '首字速度',
    latency: '完整耗时',
    adjustments: '运营微调',
    balanceTitle: '账号均衡使用',
    balanceHint: '决定健康账号的覆盖倾向，不会把流量压向紧张或满载账号。',
    peakTitle: '高峰期保护',
    peakHint: '高峰期优先保护容量；严格保护时暂停纯覆盖探索。',
    sessionTitle: '会话连续性',
    sessionHint: '只在原账号健康且有余量时保持；风险出现时仍会自动切换。',
    preview: '保存前策略预览',
    normal: '平峰请求',
    peakPreview: '高峰请求',
    sessionPreview: '会话切换',
