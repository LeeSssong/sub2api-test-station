...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/operations/account-profitability',
    name: 'AdminAccountProfitability',
    component: () => import('@/views/admin/AccountProfitabilityView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Account Profitability',
      titleKey: 'admin.accountProfitability.title',
      descriptionKey: 'admin.accountProfitability.description'
    }
  },
  {
    path: '/admin/operations/business-overview',
    name: 'AdminBusinessOverview',
    component: () => import('@/views/admin/BusinessOverviewView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Business Overview',
      titleKey: 'admin.businessOverview.title',
      descriptionKey: 'admin.businessOverview.description'
    }
  },
  {
