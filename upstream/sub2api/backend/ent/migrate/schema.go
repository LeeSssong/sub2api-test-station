...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "history_started_at", Type: field.TypeTime},
	...
	UsageLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "request_id", Type: field.TypeString, Size: 160},
		{Name: "upstream_request_id", Type: field.TypeString, Nullable: true, Size: 255},
		{Name: "logical_request_id", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "attempt_id", Type: field.TypeString, Nullable: true, Size: 160},
		{Name: "usage_completeness", Type: field.TypeString, Size: 16, Default: "complete"},
		{Name: "reconciliation_required", Type: field.TypeBool, Default: false},
		{Name: "unsafe_to_replay", Type: field.TypeBool, Default: false},
		...
		{Name: "actual_response_model", Type: field.TypeString, Nullable: true, Size: 100},
		...
		{Name: "upstream_actual_cost", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_cost_status", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "upstream_cost_reason", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "profit", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_cost_recorded_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
