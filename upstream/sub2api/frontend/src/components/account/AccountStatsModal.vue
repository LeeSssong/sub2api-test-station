      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              ...
              <span class="text-gray-400 dark:text-gray-500">
                ({{ t('usage.userBilled') }}: {{ formatUsd(stats.summary.total_user_cost) }} ·
                {{ t('admin.accounts.stats.standardCost') }}: {{
                  formatUsd(stats.summary.total_standard_cost)
                }})
              </span>
            </p>
          </div>
          ...
          >
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
              {{ formatUsd(stats.summary.avg_daily_cost) }}
            </p>
             <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{
              ...
              <span class="text-gray-400 dark:text-gray-500">
                ({{ t('usage.userBilled') }}: {{ formatUsd(stats.summary.avg_daily_user_cost) }})
              </span>
            </p>
          </div>
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ formatUsd(stats.summary.today?.cost) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ formatUsd(stats.summary.today?.user_cost) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-orange-600 dark:text-orange-400"
                  >{{ formatUsd(stats.summary.highest_cost_day?.cost) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ formatUsd(stats.summary.highest_cost_day?.user_cost) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ formatUsd(stats.summary.highest_request_day?.cost) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >{{ formatUsd(stats.summary.highest_request_day?.user_cost) }}</span
                >
              </div>
            </div>
          </div>
