...
const adminNavItems = computed((): NavItem[] => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/scheduler-settings', label: t('nav.schedulerSettings'), icon: CogIcon })
  ...
  visible.push({ path: '/admin/scheduler-settings', label: t('nav.schedulerSettings'), icon: CogIcon })
