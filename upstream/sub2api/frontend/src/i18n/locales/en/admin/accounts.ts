export default {
    accounts: {
      ...
      billingRateMultiplierPolicy: 'Billing Rate Control',
      billingRateMultiplierPolicyManaged: 'Managed from upstream billing',
      billingRateMultiplierPolicyManual: 'Manual override',
      billingRateMultiplierPolicyHint: 'Managed mode lets the next billing probe update the multiplier.',
      expiresAt: 'Expires At',
