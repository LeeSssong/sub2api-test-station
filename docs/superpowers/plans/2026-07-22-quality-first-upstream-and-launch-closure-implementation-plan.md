...
- [x] **Step 1: Write failing tests for the new profile and fast record.**
...
- [x] **Step 2: Run the focused Ruby test and confirm RED.**
...
- [x] **Step 3: Implement the minimal vendor-neutral fast runner and profiles.**
...
- [x] **Step 1: Write failing gate and score tests.**
...
- [x] **Step 2: Run Ruby and Go focused tests and confirm RED.**
...
- [x] **Step 3: Implement the evaluator and card/report projection.**
...
- [x] **Step 1: Write failing cadence, authorization, and preview tests.**
...
- [x] **Step 2: Run scheduler and HTTP tests and confirm RED.**

Run: `go test ./internal/scheduler ./internal/http -count=1`

- [x] **Step 3: Implement the minimal cadence and evidence UI.**
...
- [x] **Step 4: Run focused tests and browser/static checks.**
...
- [x] **Step 1: Capture a non-sensitive pre-state.**
...
- [x] **Step 4: Verify cleanup and write the report.**
...
- [x] **Step 1: Capture production pre-state and rollback command.**
...
- [x] **Step 2: Open the bounded write window and register one generated isolated user.**
...
- [x] **Step 3: Verify one grant and same-day idempotency.**
...
- [x] **Step 4: Restore read-only state unconditionally.**
...
- [x] **Step 1: Recheck production Feishu state without sending an event.**
