...
- 全局审计（2026-08-19）：根 `main`/`origin/main` 已同步到总账收口提交 `b853ef6eadeb502c57d588e252c4ec7bcf9a6697`；生产 release-state 绑定已验证业务源 `3bc16ee2682e6e978f73a71099c010a8353f2064`（根最新提交仅更新总账）。T27 已完成部署验收；T27 worktree/分支已归档移除，恢复 bundle `/Users/gongtengxinwen/Documents/sub2api-archives/t27-final-3bc16ee26/t27-refs.bundle`，SHA-256 `3dc2f5b131aefa7863a861cb5d2687f1217e2bbed50d836f8951ed006d2d4b04`；非 `main` 仅保留用户指定保护的 detached 视觉预览 `/private/tmp/sub2api-monitor-v3-preview`，根目录既有未跟踪资料继续保留。
