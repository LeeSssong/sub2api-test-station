export default {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        groupNamePlaceholder: 'Select an active native group',
        groupEmpty: 'No active groups for this platform',
        groupHint: 'Uses a stable group ID, so renaming the group does not break monitoring.',
